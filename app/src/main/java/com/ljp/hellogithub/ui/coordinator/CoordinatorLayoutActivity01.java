...
import com.ljp.hellogithub.view.itemdecoration.LinearItemDecoration;
...
public class CoordinatorLayoutActivity01 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coordinator_layout01);
